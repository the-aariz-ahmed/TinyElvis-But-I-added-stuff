...
public class Fun extends SubsystemBase {
    private TalonFX motor = new TalonFX(14, "main_canivore");
    private double kP = 15;
    private double kD = 1;
    private double kG = 0.833;
...
private final ArmFeedforward ff =
    ...
    private VelocityTorqueCurrentFOC control = new VelocityTorqueCurrentFOC(0);
...
private VoltageOut voltageControl = new VoltageOut(0);
  ...
  if (RobotBase.isSimulation()) {
    ...
    public Command setVelocity(double velocity) { return runEnd(() -> runMotor(velocity), () -> runMotor(0)); }
